      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 border border-gray-200 rounded-xl shadow-lg">
        <div className="flex flex-col items-center">
          ...
          <h2 className="mt-4 text-center text-3xl font-extrabold text-secondary">
            Welcome Back to QuitMate
          </h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Continue your journey to a healthier, smoke-free life
          </p>
        </div>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link to="/signup" className="font-medium text-primary hover:text-red-700 transition-colors duration-200">
              Sign up
            </Link>
          </p>
        </div>
