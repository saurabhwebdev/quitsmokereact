      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900">Breathing Exercise</h2>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="flex flex-col items-center justify-center space-y-8">
              ...
              <div className="relative">
                ...
                <div
                  className={`
                    w-64 h-64 rounded-full border-8 transition-all duration-1000 ease-in-out 
              ...
              <div className="mt-8 text-center w-full">
                <h3 className="text-xl font-medium text-gray-900 mb-6">Instructions</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="p-4 bg-blue-50 rounded-lg">
                    <div className="text-blue-500 text-lg font-medium mb-2">Inhale (4s)</div>
                    <p className="text-gray-600">Breathe in slowly through your nose</p>
                  </div>
                  <div className="p-4 bg-yellow-50 rounded-lg">
                    <div className="text-yellow-500 text-lg font-medium mb-2">Hold (7s)</div>
                    <p className="text-gray-600">Hold your breath comfortably</p>
                  </div>
                  <div className="p-4 bg-green-50 rounded-lg">
                    <div className="text-green-500 text-lg font-medium mb-2">Exhale (8s)</div>
                    <p className="text-gray-600">Release slowly through your mouth</p>
                  </div>
                </div>
              </div>
            </div>
